...
// VGI Environment: Variables de control per Menú Vista: canvi PV interactiu, Zoom i dibuixar eixos 
...
// VGI Environment: Variables de l'opció Vista->Pan
...
// VGI Environment: Variables de control de l'opció Vista->Navega?
...
// VGI Environment: Variables de control per les opcions de menú Projecció, Objecte
	char projeccio;	// Menú Projecció: Tipus de projeccio 
	char objecte;	// Menú Objecte: Tipus d'Objecte

// VGI Environment: Variables de control del menú Transforma
...
// VGI Environment: Variables de control per les opcions de menú Ocultacions
...
// VGI Environment: Variables de control del menú Iluminació	
...
// VGI Environment: Variables de control del menú Llums
...
// VGI Environment: Variables de control del menú Shaders
...
// VGI Environment: Variables que controlen paràmetres visualització: Mides finestra Windows i PV
...
// VGI Environment: Funcions de càrrega i activació de shaders
...
public:
	...
	afx_msg void OnObjectRobot();
	afx_msg void OnUpdateObjectRobot(CCmdUI *pCmdUI);
	afx_msg void OnPositiveElbowx();
	afx_msg void OnPositiveElbowz();
	afx_msg void OnPositiveWristx();
	afx_msg void OnPositiveWristy();
	afx_msg void OnPositiveWristz();
	afx_msg void OnOpenClamp();
	afx_msg void OnNegativeElbowx();
	afx_msg void OnNegativeElbowz();
	afx_msg void OnNegativeWristx();
