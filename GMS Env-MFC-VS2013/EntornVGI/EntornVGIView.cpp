...
BEGIN_MESSAGE_MAP(CEntornVGIView, CView)
	...
	ON_UPDATE_COMMAND_UI(ID_VISTA_SATELIT, &CEntornVGIView::OnUpdateVistaSatelit)
		...
		ON_COMMAND(ID_POSITIVE_ELBOWX, &CEntornVGIView::OnPositiveElbowx)
		ON_COMMAND(ID_POSITIVE_ELBOWZ, &CEntornVGIView::OnPositiveElbowz)
		ON_COMMAND(ID_POSITIVE_WRISTX, &CEntornVGIView::OnPositiveWristx)
		ON_COMMAND(ID_POSITIVE_WRISTY, &CEntornVGIView::OnPositiveWristy)
		ON_COMMAND(ID_POSITIVE_WRISTZ, &CEntornVGIView::OnPositiveWristz)
		ON_COMMAND(ID_OPEN_CLAMP, &CEntornVGIView::OnOpenClamp)
		ON_COMMAND(ID_NEGATIVE_ELBOWX, &CEntornVGIView::OnNegativeElbowx)
		ON_COMMAND(ID_NEGATIVE_ELBOWZ, &CEntornVGIView::OnNegativeElbowz)
		ON_COMMAND(ID_NEGATIVE_WRISTX, &CEntornVGIView::OnNegativeWristx)
...
void CEntornVGIView::Teclat_Robot(UINT nChar, UINT nRepCnt)
{
	...
	if (nChar == VK_F5 && anima == true) {
		anima = false;
		KillTimer(WM_TIMER);
	}else if (nChar == VK_F5 && anima == false) {
		anima = true;
		counter = 0;
		i = 0;
...
void CEntornVGIView::OnPositiveElbowz()
{
	if (objecte == ROBOT)
	{
		InElZP();
...
void CEntornVGIView::OnNegativeElbowz()
{
	if (objecte == ROBOT)
	{
		InElZN();
...
void CEntornVGIView::OnPositiveElbowx()
{
	if (objecte == ROBOT)
	{
		InElXP();
...
void CEntornVGIView::OnNegativeElbowx()
{
	if (objecte == ROBOT)
	{
		InElXN();
...
void CEntornVGIView::OnPositiveWristz()
{
	if (objecte == ROBOT)
	{
		InWrZP();
...
void CEntornVGIView::OnNegativeWristz()
{
	if (objecte == ROBOT)
	{
		InWrZN();
...
void CEntornVGIView::OnPositiveWristx()
{
	if (objecte == ROBOT)
	{
		InWrXP();
...
void CEntornVGIView::OnNegativeWristx()
{
	if (objecte == ROBOT)
	{
		InWrXN();
...
void CEntornVGIView::OnPositiveWristy()
{
	if (objecte == ROBOT)
	{
		InWrYP();
...
void CEntornVGIView::OnNegativeWristy()
{
	if (objecte == ROBOT)
	{
		InWrYN();
...
void CEntornVGIView::OnOpenClamp()
{
	if (objecte == ROBOT)
	{
		InCl();
...
void CEntornVGIView::OnCloseClamp()
{
	if (objecte == ROBOT)
	{
		DeCl();
