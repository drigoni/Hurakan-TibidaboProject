...
/*//Angles for robot arm
static float elbowz = 0.0, elbowx, wristz = 0.0, wristx = 0.0, wristy = 0.0, clamp = 45.0;*/
...
/*//Base robot
void robot_base(bool textu, GLuint VTextu[NUM_MAX_TEXTURES])
{
...
void robot_clamp(bool textu, GLuint VTextu[NUM_MAX_TEXTURES])
{
	...
	glPushMatrix();
	glRotatef(clamp, 1.0f, 0.0f, 0.0f);
	glTranslatef(0.0f, -1.0f, 3.5f);
...
glPushMatrix();
	...
	glPushMatrix();
	glTranslatef(0.0f, 0.0f, 15.0f);
	glRotatef(elbowz, 1.0f, 0.0f, 0.0f);
	glRotatef(elbowx, 0.0f, 0.0f, 1.0f);
	glTranslatef(0.0f, 0.0f, -15.0f);
	//Arm
	glColor3f(0.5f, 0.5f, 0.5f);
	glPushMatrix();
	...
	glPushMatrix();
	glTranslatef(0.0f, -15.0f, 15.0f);
	glRotatef(wristz, 0.0f, 0.0f, 1.0f);
	glRotatef(wristx, 0.0f, 1.0f, 0.0f);
	glRotatef(wristy, 1.0f, 0.0f, 0.0f);
	glTranslatef(0.0f, 15.0f, -15.0f);
